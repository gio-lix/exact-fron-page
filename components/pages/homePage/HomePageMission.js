        ...
        <>
            <div className='w-full bg-bgList mt-7 sm:mt-10 lg:mt-20 sm:px-[50px] md:px-[100px] lg:px-[200px] 2xl:px-[320px] group '>
                ...
                <div className=' bg-list flex sm:justify-between mt-5 lg:mt-10 flex-wrap '>
                    <div className='bg-bgList group  border border-gray-300 cursor-pointer w-full h-[160px] md:w-[308px] border flex items-center justify-around'>
                    ...
                    <div className='bg-bgList border border-gray-300  cursor-pointer w-full h-[160px] md:w-[308px] border flex items-center justify-around '>
                        <div className='relative h-[119px] w-[119px]   '>
